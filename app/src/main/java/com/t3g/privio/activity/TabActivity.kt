    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottom_navigation.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.nav_menu -> {
                    when {
                        (web_view.url!!.toString().startsWith(getString(R.string.homePage))) -> {
                                    ...
                                    when {
                                        ...
                                        web_view.url!!.startsWith("http") -> {
                                            ...
                                            message = if (jsonLink != null && jsonTitle != null) {
                                                ...
                                                linkList.add(web_view!!.url!!.toString())
                                                titleList.add(web_view!!.title.toString())
                                                val editor = sharedPreferences.edit()
...
//                    Share
                            bottomSheetView.findViewById<View>(R.id.share).setOnClickListener {
                                ...
                                if (web_view.url!!.startsWith(getString(R.string.homePage))) {
...
//                    settt
    ...
    override fun onBackPressed() {
        ...
        if (webView.canGoBack()) {
            ...
            builder.setMessage("Are you sure?")
                .setPositiveButton(
                    Html.fromHtml("<font color='#000000'>Yes</font>"), dialogClickListener
                )
                .setNegativeButton(
                    Html.fromHtml("<font color='#000000'>No</font>"), dialogClickListener
                )
                .show()
        }
    }
    ...
    private fun loadImg() {
        val bgImg = "https://unsplash.com/photos/j_gnGCDQRew"
