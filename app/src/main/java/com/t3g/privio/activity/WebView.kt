...
import com.t3g.privio.classes.WebChromeClient
import com.t3g.privio.classes.WebViewClient
...
class WebView @JvmOverloads constructor(
    ...
    fun loadHome() {
        ...
        loadUrl(context.getString(R.string.homePage))
    }
    ...
    fun search(searchQuery: String) {
        ...
        if (Patterns.WEB_URL.matcher(pQuery).matches()) {
            ...
            web_view.loadUrl("https://duckduckgo.com/?va=f&t=hi&q=$pQuery&ia=web")
    ...
    private fun initSettings() {
        ...
        userAgentList.add(userAgentList.size - 1, "Privio")
