...
import static com.winkbr.browser.activity.TabActivity.PREFERENCES;
import static com.winkbr.browser.activity.TabActivity.WEB_LINKS;
import static com.winkbr.browser.activity.TabActivity.WEB_TITLE;
...
//        Custom ActionBar
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (o instanceof Map) {
                    Map map = (Map) o;
                    Intent intent = new Intent(BookmarkActivity.this, TabActivity.class);
